...
class RankingServiceProvider extends ServiceProvider
{
    ...
    public function register(): void
    {
        $this->app->singleton(RankingContract::class, function ($app) {
            return $app->config->get('form-maker.sorting.ranking', new Ranking());
        });
    }
    ...
    protected function publishMigration(): void
    {
        ...
        $this->publishes([
            __DIR__ . '/../../../database/migrations/create_ranking_tables.php' => database_path('migrations/' . $timestamp . '_create_form_maker_tables.php'),
        ], 'ranking-migrations');
    }
}
