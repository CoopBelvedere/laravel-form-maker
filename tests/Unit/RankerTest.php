...
class RankerTest extends TestCase
{
    ...
    /** @test */
    public function add_node_after_another_node_in_ranking_when_first_node_is_ahead_in_ranking()
    {
        $this->ranker->ranks = [1,2,3];
    ...
    /** @test */
    public function add_node_after_another_node_in_ranking_when_first_node_is_behind_in_ranking()
    {
        $this->ranker->ranks = [1,2,3];
    ...
    /** @test */
    public function add_node_after_another_node_in_ranking_when_nodes_are_equal_in_ranking()
    {
        $this->ranker->ranks = [1,2,3];
    ...
    /** @test */
    public function add_node_after_another_node_in_ranking_after_node_doesnt_exist_in_ranking()
    {
        $this->ranker->ranks = [1,2,3];
    ...
    /** @test */
    public function add_node_after_another_node_in_ranking_first_node_doesnt_exist_in_ranking()
    {
        $this->ranker->ranks = [1,2,3];
    ...
    /** @test */
    public function add_node_after_another_node_without_using_move_method_before()
    {
        $this->ranker->ranks = [1,2,3];
